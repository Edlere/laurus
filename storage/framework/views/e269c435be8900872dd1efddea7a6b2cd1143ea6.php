<?php $__env->startSection('title', '| Registrar Historia Clinica'); ?>
...
<?php echo e(Form::open (['route' => 'GuardarHistoriaClinica' ,'class' => 'form-horizontal','id' => 'FrmRegistrarHistoriaClinica'] )); ?>
                ...
                <h2 class="text-center" style="color: #03a9f4;">Registar Historia Clínica</h2>
                    ...
                    <div class="tab-content" id="myTabContent">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-3">
                                        ...
                                        <select name="tipo_historia_id" id="tipo_historia_id" class="form-control">
                                            <?php $__currentLoopData = $historiatipos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $historiatipo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($historiatipo->id); ?>"><?php echo e($historiatipo->nombre_historia); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                    <div class="col-sm-3">
                                        <label for="" class="">Fecha de Historia</label>
                                            <?php echo e(Form::text('fecha_historia', \Carbon\Carbon::now()->format("Y-n-j"), ['class' => 'datepicker form-control text-center' , 'data-date-format' => 'yyyy-mm-dd'])); ?>
                        ...
                        <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                          <div class="row">
                            <?php $__currentLoopData = $biologicas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $biologica): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <div class="form-group col-sm-4">
                                  <label for="col-sm-2"><?php echo e($biologica->nombre_campo); ?></label>
                                  <select class="form-control col-sm-2" name="biologicas[]" id="biologica_<?php echo e($biologica->id); ?>">
                           ...
                           <div class="form-group">
                                    ...
                                    <br>
                                    <?php echo e(Form::textarea('paciente_funciones_biologicas',null,['class' => 'form-control' ,'id' => 'textarea', 'placeholder' => 'Digite Aquí Observaciones', 'Description'])); ?>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <br>
                                            <?php echo e(Form::textarea('paciente_antecedentes_generales',null,['class' => 'form-control' ,'id' => 'textarea', 'placeholder' => 'Digite Aquí Observaciones', 'Description'])); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <br>
                                            <?php echo e(Form::textarea('paciente_antecedentes_fisiologicos',null,['class' => 'form-control' ,'id' => 'textarea', 'placeholder' => 'Digite Aquí Observaciones', 'Description'])); ?>
                        ...
                        <div class="tab-pane fade" id="familiares" role="tabpanel" aria-labelledby="familiares-tab">
                            ...
                            <div class="row">
                                <?php $__currentLoopData = $familiares; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $familiar): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="form-group col-sm-4">
                                                <label for="col-sm-2"><?php echo e($familiar->nombre_campo); ?></label>
                                                <select class="form-control col-sm-2" name="familiares[]" id="familiar_<?php echo e($familiar->id); ?>">
                                                  <option value="1">Si</option>
                                                  <option value="2">No</option>
                                                </select>
                                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <br>
                                    <?php echo e(Form::textarea('paciente_antecedentes_familiares_otros',null,['class' => 'form-control' ,'id' => 'textarea', 'placeholder' => 'Digite Aquí Observaciones', 'Description'])); ?>
                        ...
                        <div class="tab-pane fade" id="patologicos" role="tabpanel" aria-labelledby="patologicos-tab">
                            ...
                            <div class="row">
                                <?php $__currentLoopData = $patologicos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $patologico): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="form-group col-sm-4">
                                                <label for="col-sm-2"><?php echo e($patologico->nombre_campo); ?></label>
                                                <select class="form-control col-sm-2" name="patologicos[]" id="patologico_<?php echo e($patologico->id); ?>">
                                                  <option value="1">Si</option>
                                                  <option value="2">No</option>
                                                </select>
                                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <br>
                                <?php echo e(Form::textarea('paciente_antecedentes_patologicos_otros',null,['class' => 'form-control' ,'id' => 'textarea', 'placeholder' => 'Digite Aquí Observaciones', 'Description'])); ?>
                        ...
                        <div class="tab-pane fade" id="gineco" role="tabpanel" aria-labelledby="gineco-tab">
                            ...
                            <div class="row">
                                <div class="form-group col-sm-4">
                                    ...
                                    <?php echo e(Form::text('gineco_menarquia', \Carbon\Carbon::now()->format("Y-n-j"), ['class' => 'datepicker form-control col-sm-10 text-center' , 'data-date-format' => 'yyyy-mm-dd'])); ?>
                                ...
                                <div class="form-group col-sm-4">
                                    ...
                                    <?php echo e(Form::text('gineco_fur', \Carbon\Carbon::now()->format("Y-n-j"), ['class' => 'datepicker form-control col-sm-10 text-center' , 'data-date-format' => 'yyyy-mm-dd'])); ?>
                            ...
                            <div class="row">
                                <div class="form-group col-sm-4">
                                    ...
                                    <select name="gineco_edad_gestacional" id="gineco_edad_gestacional" class="form-control text-center">
                                        <?php for($i = 0; $i < 44; $i++): ?>
                                            <option value="<?php echo e($i); ?>"><?php echo e($i); ?> semanas</option> 
                                        <?php endfor; ?>
                            ...
                            <div class="row">   
                                <div class="form-group col-sm-4">
                                    ...
                                    <?php echo e(Form::text('gineco_irs', \Carbon\Carbon::now()->format("Y-n-j"), ['class' => 'datepicker form-control col-sm-10 text-center' , 'data-date-format' => 'yyyy-mm-dd'])); ?>

                                </div>
                                <div class="form-group col-sm-4">
                                    <label for="gineco_urs" class="col-sm-2">URS</label>
                                    <?php echo e(Form::text('gineco_urs', \Carbon\Carbon::now()->format("Y-n-j"), ['class' => 'datepicker form-control col-sm-10 text-center' , 'data-date-format' => 'yyyy-mm-dd'])); ?>
                                ...
                                <div class="form-group col-sm-4">
                                    ...
                                    <select name="gineco_mac" id="gineco_mac" class="form-control text-center">
                                        <?php $__currentLoopData = $macs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mac): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($mac->id); ?>"><?php echo e($mac->nombre_campo); ?></option> 
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-sm-4">
                                    ...
                                    <select name="gineco_tipo_parto" id="gineco_tipo_parto" class="form-control text-center">
                                        <?php $__currentLoopData = $tipopartos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tipoparto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($tipoparto->id); ?>"><?php echo e($tipoparto->nombre_campo); ?></option> 
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                                 <div class="form-group col-sm-4">
                            ...
                            <div class="form-group">
                                ...
                                <br>
                                <?php echo e(Form::textarea('paciente_antecedentes_gineco_otros',null,['class' => 'form-control' ,'id' => 'textarea', 'placeholder' => 'Digite Aquí Observaciones', 'Description'])); ?>
                        ...
                        <div class="tab-pane fade" id="fisico" role="tabpanel" aria-labelledby="fisico-tab">
                            ...
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <br>
                                    <?php echo e(Form::textarea('paciente_observaciones_examen_fisicos',null,['class' => 'form-control' ,'id' => 'textarea', 'placeholder' => 'Digite Aquí Observaciones', 'Description'])); ?>
                            ...
                            <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <br>
                                                <?php echo e(Form::textarea('paciente_general_apreciacion',null,['class' => 'form-control' ,'id' => 'textarea', 'placeholder' => 'Digite Aquí Comentarios', 'Description'])); ?>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <br>
                                                <?php echo e(Form::textarea('paciente_general_piel_faneras',null,['class' => 'form-control' ,'id' => 'textarea', 'placeholder' => 'Digite Aquí sus Comentarios', 'Description'])); ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <br>
                                                <?php echo e(Form::textarea('paciente_general_conjuntivas',null,['class' => 'form-control' ,'id' => 'textarea', 'placeholder' => 'Digite Aquí sus Comentarios', 'Description'])); ?>
                            ...
                            <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <br>
                                                <?php echo e(Form::textarea('paciente_general_cuello',null,['class' => 'form-control' ,'id' => 'textarea', 'placeholder' => 'Digite Aquí Comentarios', 'Description'])); ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <br>
                                                <?php echo e(Form::textarea('paciente_general_torax_pulmones',null,['class' => 'form-control' ,'id' => 'textarea', 'placeholder' => 'Digite Aquí sus Comentarios', 'Description'])); ?>
                            ...
                            <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <br>
                                                <?php echo e(Form::textarea('paciente_general_cardiovascular',null,['class' => 'form-control' ,'id' => 'textarea', 'placeholder' => 'Digite Aquí sus Comentarios', 'Description'])); ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <br>
                                                <?php echo e(Form::textarea('paciente_general_abdomen',null,['class' => 'form-control' ,'id' => 'textarea', 'placeholder' => 'Digite Aquí sus Comentarios', 'Description'])); ?>
                            ...
                            <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <br>
                                                <?php echo e(Form::textarea('paciente_general_genito_urinario',null,['class' => 'form-control' ,'id' => 'textarea', 'placeholder' => 'Digite Aquí sus Comentarios', 'Description'])); ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <br>
                                                <?php echo e(Form::textarea('paciente_general_sistema_nervioso',null,['class' => 'form-control' ,'id' => 'textarea', 'placeholder' => 'Digite Aquí sus Comentarios', 'Description'])); ?>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <br>
                                                <?php echo e(Form::textarea('paciente_plantrabajo_ayuda_dignostica',null,['class' => 'form-control' ,'id' => 'textarea', 'placeholder' => 'Digite Aquí Observaciones', 'Description'])); ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <br>
                                                <?php echo e(Form::textarea('paciente_plantrabajo_laboratorio',null,['class' => 'form-control' ,'id' => 'textarea', 'placeholder' => 'Digite Aquí Observaciones', 'Description'])); ?>
                            ...
                            <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <br>
                                                <?php echo e(Form::textarea('paciente_plantrabajo_estudio_imagenes',null,['class' => 'form-control' ,'id' => 'textarea', 'placeholder' => 'Digite Aquí Observaciones', 'Description'])); ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <br>
                                                <?php echo e(Form::textarea('paciente_plantrabajo_procedimientos_especiales',null,['class' => 'form-control' ,'id' => 'textarea', 'placeholder' => 'Digite Aquí Observaciones', 'Description'])); ?>
                            ...
                            <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <br>
                                                <?php echo e(Form::textarea('paciente_plantrabajo_interconsultas',null,['class' => 'form-control' ,'id' => 'textarea', 'placeholder' => 'Digite Aquí Observaciones', 'Description'])); ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <br>
                                                <?php echo e(Form::textarea('paciente_plantrabajo_referencia',null,['class' => 'form-control' ,'id' => 'textarea', 'placeholder' => 'Digite Aquí Observaciones', 'Description'])); ?>
                                ...
                                <div class="row">
                                    <div class="col-xs-10 col-xs-offset-1">
                                        <div class="form-group">
                                            ...
                                            <br>
                                                <?php echo e(Form::textarea('paciente_tratamiento',null,['class' => 'form-control' ,'id' => 'textarea', 'placeholder' => 'Digite Aquí el Tratamiento', 'Description'])); ?>
